...
export default function ProjectsPage() {
  ...
  return (
    <main className="min-h-screen bg-background overflow-x-hidden">
      ...
      {/* Hero Section */}
      <section ref={heroRef} className="relative pt-40 sm:pt-52 md:pt-64 pb-16 sm:pb-20 md:pb-24 min-h-[70vh] flex items-center overflow-hidden">
        <FloatingParticles />
      ...
      {otherProjects.length > 0 && (
        <section className="py-10 sm:py-12 md:py-14 lg:py-16 bg-secondary/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
      ...
      {/* CTA Section */}
      <section className="py-10 sm:py-12 md:py-14 lg:py-16 relative overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
