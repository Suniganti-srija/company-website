...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#e3f2fd] via-[#e8f4fc] to-[#f0f9ff]">
      ...
      {/* Hero Section */}
      <section id="home" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden pt-40 sm:pt-32 md:pt-20">
      ...
      <section id="business" className="py-12 sm:py-14 md:py-16 lg:py-18 relative overflow-hidden bg-gradient-to-b from-white via-slate-50 to-white">
        {/* Animated Background */}
        <motion.div
          className="absolute inset-0"
          animate={{
      ...
      {/* Stats Section */}
      <section id="achievements" className="py-12 sm:py-14 md:py-16 lg:py-18 bg-white/60 backdrop-blur-sm relative overflow-hidden">
        <motion.div
      ...
      {/* Services Section */}
      <section id="services" className="py-12 sm:py-14 md:py-16 lg:py-18 relative overflow-hidden bg-gradient-to-b from-[#f0f9ff] to-[#e3f2fd]">
      ...
      <section id="why-us" className="py-12 sm:py-14 md:py-16 lg:py-18 bg-white/70 relative overflow-hidden">
      ...
      {/* CEO Quote Section */}
      <section id="contact-cta" className="py-12 sm:py-14 md:py-16 lg:py-18 relative overflow-hidden bg-gradient-to-r from-[#e3f2fd] via-[#e8f4fc] to-[#e1f5fe]">
        <motion.div
          className="absolute inset-0"
          animate={{
            background: [
