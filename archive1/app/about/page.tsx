      ...
      <section className="relative pt-56 sm:pt-64 md:pt-72 pb-16 sm:pb-20 md:pb-24 overflow-hidden min-h-screen flex items-center">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          >
            ...
            >
              Building the{" "}
              <span className="text-primary">Future</span> of Technology
            </motion.h1>
            <motion.p
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              A decade of innovation, excellence, and unwavering commitment to transforming
              ideas into reality. We&apos;re not just building software; we&apos;re building
              a better tomorrow.
            </motion.p>
          </motion.div>
        </div>
