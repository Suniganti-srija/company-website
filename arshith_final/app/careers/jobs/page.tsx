...
export default function JobsPage() {
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="relative pt-20 sm:pt-28 pb-14 sm:pb-20 overflow-hidden min-h-[50vh] flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.h1
              ...
              className="text-3xl sm:text-5xl md:text-6xl font-bold text-foreground mt-3 mb-4 leading-tight"
            >
              Find Your{" "}
