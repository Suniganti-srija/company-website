                  ...
                  >
                    <Link href="/contact">
                      <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className={`px-6 py-3 sm:px-8 sm:py-4 bg-gradient-to-r ${service.gradient} text-white rounded-xl font-bold flex items-center justify-center gap-2 shadow-xl hover:shadow-2xl transition-shadow w-full sm:w-auto`}
                      >
                        Get Started
                        <ArrowRight className="w-5 h-5" />
                      </motion.button>
