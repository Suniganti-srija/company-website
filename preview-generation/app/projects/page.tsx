...
export default function ProjectsPage() {
  ...
  return (
    <main className="min-h-screen bg-background overflow-x-hidden">
      ...
      {/* Hero Section */}
      <section ref={heroRef} className="relative min-h-[60vh] sm:min-h-[80vh] flex items-center overflow-hidden">
        <FloatingParticles />
        ...
        <motion.div 
          style={{ y: heroY }}
          className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 md:pt-20 pb-8 sm:pb-12 md:pb-16 lg:pb-32"
        >
          <motion.div
      ...
      {featuredProjects.length > 0 && (
        <section className="py-12 sm:py-16 md:py-20 lg:py-32">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-8 sm:space-y-10 md:space-y-10">
              {featuredProjects.map((project, index) => (
                <motion.div
                  ...
                  } gap-5 sm:gap-6 md:gap-8 items-start lg:items-center`}
                >
                  {/* Image */}
                  <motion.div
                  ...
                  >
                    <div className="relative h-52 sm:h-64 lg:h-[450px] w-full rounded-3xl overflow-hidden shadow-2xl">
                      <Image
                        src={project.image}
                        alt={project.title}
                        fill
      ...
      {otherProjects.length > 0 && (
        <section className="py-12 sm:py-16 md:py-20 lg:py-32 bg-secondary/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
