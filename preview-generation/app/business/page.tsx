    ...
    <main className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <motion.div 
          ...
          className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 md:pt-20 pb-10 sm:pb-14 md:pb-20 lg:pb-32"
        >
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-32 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-16 sm:space-y-12 md:space-y-16 lg:space-y-20">
            {services.map((service, index) => (
              <motion.div
                ...
                } gap-5 sm:gap-6 md:gap-8 lg:gap-12 items-start lg:items-center`}
              >
                ...
                >
                  <Card3D className="relative">
                    <div className="relative h-52 sm:h-64 lg:h-[500px] w-full rounded-3xl overflow-hidden shadow-2xl">
                      <Image
                        src={service.image}
                        alt={service.title}
                        fill
                      ...
                      <motion.div
                        ...
                        viewport={{ once: true }}
                        className="absolute bottom-6 left-6 w-14 h-14 sm:w-20 sm:h-20 bg-white rounded-2xl flex items-center justify-center shadow-2xl"
                      >
                        <service.icon className="w-7 h-7 sm:w-10 sm:h-10 text-blue-600" />
                      </motion.div>
                  ...
                  {/* Decorative elements - hidden on mobile to prevent phantom space */}
                  <motion.div
                    className={`hidden lg:block absolute -z-10 w-full h-full rounded-3xl bg-gradient-to-br ${service.gradient} opacity-20`}
                ...
                >
                  ...
                  <motion.h3
                    ...
                    transition={{ delay: 0.3 }}
                    viewport={{ once: true }}
                    className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-foreground mb-3 sm:mb-4 md:mb-6 [word-break:normal] [hyphens:none] [overflow-wrap:normal]"
                  >
                    {service.title}
                  </motion.h3>
                  ...
                  <motion.div
                    ...
                    transition={{ delay: 0.8 }}
                    viewport={{ once: true }}
                    className="flex flex-col xs:flex-row flex-wrap items-start sm:items-center gap-3 sm:gap-4"
                  >
                    <Link href="/contact" className="inline-block w-auto flex-shrink-0">
                      <motion.button
                        whileHover={{ scale: 1.05, x: 5 }}
                        whileTap={{ scale: 0.95 }}
                        className={`px-6 py-3 bg-gradient-to-r ${service.gradient} text-white rounded-xl font-bold inline-flex items-center gap-2 shadow-xl hover:shadow-2xl transition-shadow whitespace-nowrap`}
                      >
                        Get Started
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-32 relative overflow-hidden bg-gradient-to-b from-background via-slate-50 to-background">
        <AnimatedGrid />
        <FloatingParticles />
