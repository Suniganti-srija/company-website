...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#e3f2fd] via-[#e8f4fc] to-[#f0f9ff]">
      ...
      {/* Hero Section */}
      <section id="home" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden pt-32 md:pt-20">
        ...
        <motion.div 
          ...
          className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-20"
        >
          <motion.div
      ...
      <section id="business" className="py-12 sm:py-16 md:py-20 lg:py-24 relative overflow-hidden bg-gradient-to-b from-white via-slate-50 to-white">
        {/* Animated Background */}
        <motion.div
          className="absolute inset-0"
          animate={{
      ...
      {/* Stats Section */}
      <section id="achievements" className="py-12 sm:py-16 md:py-20 lg:py-24 bg-white/60 backdrop-blur-sm relative overflow-hidden">
        <motion.div
      ...
      {/* Services Section */}
      <section id="services" className="py-12 sm:py-16 md:py-20 lg:py-24 relative overflow-hidden bg-gradient-to-b from-[#f0f9ff] to-[#e3f2fd]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            {services.map((service, index) => (
              ...
              >
                ...
                <h3 className="relative text-xl font-bold text-slate-800 mb-3 group-hover:text-blue-600 transition-colors [word-break:normal] [hyphens:none]">
                  {service.title}
                </h3>
      ...
      <section id="why-us" className="py-12 sm:py-16 md:py-20 lg:py-24 bg-white/70 relative overflow-hidden">
      ...
      {/* CEO Quote Section */}
      <section id="contact-cta" className="py-12 sm:py-16 md:py-20 lg:py-24 relative overflow-hidden bg-gradient-to-r from-[#e3f2fd] via-[#e8f4fc] to-[#e1f5fe]">
        <motion.div
          className="absolute inset-0"
          animate={{
            background: [
