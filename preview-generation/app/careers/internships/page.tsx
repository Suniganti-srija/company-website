...
export default function InternshipsPage() {
  return (
    <main className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="relative pt-36 md:pt-28 pb-20 overflow-hidden min-h-[70vh] flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.h1
              ...
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground [word-break:normal] [overflow-wrap:break-word] [hyphens:none]"
            >
              Launch Your{" "}
            ...
            {internshipDomains.map((domain, index) => (
              ...
              >
                ...
                <div className="p-5 sm:p-8">
                  ...
                  <h3 className="text-2xl font-bold text-foreground mb-4 hyphens-none [word-break:normal] [overflow-wrap:normal]">{domain.title}</h3>
            ...
            <div className="relative">
              ...
              {curriculum[domain.id as keyof typeof curriculum].map((item, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="relative flex gap-3 sm:gap-6 mb-6 sm:mb-8 w-full"
                >
                  <motion.div
                    whileHover={{ scale: 1.2 }}
                    className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-primary flex items-center justify-center flex-shrink-0 z-10"
                  >
                    <span className="text-white font-bold text-xs sm:text-sm leading-tight text-center px-1">{item.week.split(" ")[1]}</span>
                  </motion.div>
                  <motion.div
                    whileHover={{ x: 5 }}
                    className="bg-white p-4 sm:p-6 rounded-xl shadow-md flex-1 min-w-0 overflow-hidden"
                  >
                    <span className="text-primary font-medium text-sm">{item.week}</span>
                    <h4 className="text-base sm:text-lg font-bold text-foreground mt-1 [word-break:normal] [overflow-wrap:break-word] [hyphens:none]">{item.topic}</h4>
