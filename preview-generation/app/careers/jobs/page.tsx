...
export default function JobsPage() {
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="relative pt-40 md:pt-36 pb-20 overflow-hidden min-h-[60vh] flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.h1
              ...
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mt-4 mb-6 [word-break:normal] [overflow-wrap:break-word] [hyphens:none]"
            >
              Find Your{" "}
              ...
              >
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                  <div className="flex-grow">
                    ...
                    <h3 className="text-xl md:text-2xl font-bold text-foreground mb-3 hover:text-primary transition-colors hyphens-none">
                      {job.title}
                    </h3>
