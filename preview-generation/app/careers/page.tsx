...
export default function CareersPage() {
  return (
    <main className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="relative pt-36 md:pt-24 pb-20 overflow-hidden min-h-[60vh] flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.h1
              ...
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mt-4 mb-6 [word-break:normal] [hyphens:none]"
            >
              Build Your{" "}
