...
function GlowingOrb({ className }: { className?: string }) {
  return (
    <motion.div
      className={`absolute rounded-full bg-gradient-to-r from-primary/30 to-accent/30 blur-3xl ${className}`}
      animate={{
        scale: [1, 1.2, 1],
        opacity: [0.2, 0.4, 0.2],
      }}
...
export default function AboutPage() {
  ...
  return (
    <main className="min-h-screen bg-background overflow-x-hidden">
      ...
      {/* Hero Section */}
      <section ref={heroRef} className="relative pt-36 sm:pt-40 md:pt-32 pb-20 overflow-hidden min-h-[80vh] flex items-start sm:items-center">
        <ParticleField />
        ...
        >
          ...
          >
            <motion.div
              ...
              className="inline-flex self-start items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/20 rounded-full mb-4"
            >
              <motion.div
                animate={{ rotate: 360 }}
            ...
            <motion.h1
              ...
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mt-0 mb-6 [word-break:normal] [overflow-wrap:break-word] [hyphens:none]"
            >
              <motion.span
