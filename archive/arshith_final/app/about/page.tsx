...
export default function AboutPage() {
  ...
  return (
    <main className="min-h-screen bg-background overflow-x-hidden">
      ...
      {/* Hero Section */}
      <section ref={heroRef} className="relative pt-28 sm:pt-32 md:pt-28 pb-16 sm:pb-20 overflow-hidden min-h-screen sm:min-h-[80vh] flex items-end sm:items-center">
        <ParticleField />
        ...
        <motion.div 
          className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pb-8 sm:pb-0"
        >
          <motion.div
