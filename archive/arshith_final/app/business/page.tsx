...
export default function BusinessPage() {
  ...
  return (
    <main className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="py-10 sm:py-16 md:py-20 lg:py-32 relative">
        <FloatingParticles />
                  ...
                  >
                    <Link href="/contact">
                      <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className={`px-6 py-3 sm:px-8 sm:py-4 bg-gradient-to-r ${service.gradient} text-white rounded-xl font-bold flex items-center gap-2 shadow-xl hover:shadow-2xl transition-shadow w-full sm:w-auto justify-center`}
                      >
                        Get Started
                        <ArrowRight className="w-5 h-5" />
                      </motion.button>
      ...
      <section className="py-14 sm:py-20 md:py-28 relative overflow-hidden bg-gradient-to-b from-background via-slate-50 to-background">
        <AnimatedGrid />
        <FloatingParticles />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          {/* Case Studies Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mb-10 sm:mb-16 md:mb-20">
            {[
              {
