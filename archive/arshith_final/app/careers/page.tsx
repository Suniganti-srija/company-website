...
export default function CareersPage() {
  return (
    <main className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="relative pt-20 sm:pt-28 md:pt-24 pb-14 sm:pb-20 overflow-hidden min-h-[50vh] flex items-center">
            ...
            {careerPaths.map((path, index) => (
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-foreground mb-3 leading-snug">{path.title}</h3>
