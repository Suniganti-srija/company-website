...
export default function InternshipsPage() {
  return (
    <main className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="relative pt-24 sm:pt-28 md:pt-24 pb-16 overflow-hidden min-h-[calc(100vh-80px)] sm:min-h-0 flex items-center">
            ...
            {internshipDomains.map((domain, index) => (
              ...
              >
                ...
                <div className="p-5 sm:p-8">
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-4 break-words hyphens-none">{domain.title}</h3>
            ...
            <div className="relative">
              ...
              {curriculum[domain.id as keyof typeof curriculum].map((item, index) => (
                ...
                >
                  ...
                  >
                    <span className="text-white font-bold text-sm">{item.week.split(" ")[1]}</span>
                  </motion.div>
                  <motion.div
                    whileHover={{ x: 5 }}
                  ...
                  >
                    ...
                    <h4 className="text-base sm:text-lg font-bold text-foreground mt-1 break-words">{item.topic}</h4>
